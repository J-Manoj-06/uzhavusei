...
class _BookDetailsPageState extends State<BookDetailsPage> {
  ...
  void _showBorrowDialog(MarketplaceEquipmentModel item) {
  ...
  void _handleReserveBook(MarketplaceEquipmentModel item) async {
    try {
                    ...
                    Row(
                      children: [
                        ...
                        Chip(
                          ...
                          backgroundColor: DetailsTheme.primary.withOpacity(0.08),
                ...
                StreamBuilder<List<BorrowRequestModel>>(
                  ...
                  builder: (context, reqSnap) {
                    ...
                    if (item.availableCopies <= 0) {
                      return ElevatedButton.icon(
                        onPressed: () => _handleReserveBook(item),
                    ...
                    return ElevatedButton.icon(
                      onPressed: () => _showBorrowDialog(item),
              ...
              return GestureDetector(
                ...
                child: url.isNotEmpty
                    ? CachedNetworkImage(
                        ...
                        errorWidget: (_, __, ___) => const Icon(Icons.book_rounded, size: 64, color: Colors.grey),
                      )
